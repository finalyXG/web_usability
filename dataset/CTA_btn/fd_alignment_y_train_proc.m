...
%         d9 = [d9, var(d9)];
        ...
        fd_alignment_y_train = [fd_alignment_y_train ; ...
        tmp];
    % d0 d1 d5(1) d6 d9(1) d10 d11 d12 top_text_type_encode
    end
       
end
save('fd_alignment_y_train.mat','fd_alignment_y_train');