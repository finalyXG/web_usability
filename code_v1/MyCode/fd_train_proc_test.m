...
page_nb_elements = importdata('page_nb_elements_test.mat');
page_nb_elements_type = importdata('page_nb_elements_type_test.mat');
...
%     mboxes_DTs = page_mboxes_DT{i};
    split_inds = [split_inds; size(mboxes,1)];
...
%         t4 = top_type;
        ...
        fd_test = [fd_test ;c0 c1 c2 d3 d5 d7 d9 d4 d6 d8 d10 ]; 
%         fd_test = [fd_test ; [s1 dt c1 c2 d1 d2 d4 d6 d8 d10] ]; 
        % s1 d0 e1 c1 c2 d1 d2 h5 h6 h7 h8 w5 w6 w7 w8
        %  d3 d4 d5 d6 d7 d8 d9 d10 t1 t2 t3 t4
%         fd_test = [fd_test ; d1 d2 d3 d4 d5 d6 d7 d8 d9 d10 d11 d12 d13 d14 d19 d20 d21 d22]; 
    end
