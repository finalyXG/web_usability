...
elseif ismac
	...
	options.COMPILER = 'gcc-6.0';%'gcc-4.0';    
	options.COMPFLAGS = '-fno-common -no-cpp-precomp -arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -mmacosx-version-min=10.9  -fexceptions';
% 	options.COMPFLAGS = '-fno-common -no-cpp-precomp -arch x86_64 -isysroot /Developer/SDKs/MacOSX10.6.sdk -mmacosx-version-min=10.6  -fexceptions';
	options.COPTIMFLAGS = '-O2 -DNDEBUG';
...
%         clear randomseed randbinom randgamma sample_hist
