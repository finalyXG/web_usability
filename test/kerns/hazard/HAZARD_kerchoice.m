...
kchoice=uicontrol( ...
        ...
        'Tag','HAZARD_KPREDEF');
%  button OK
predef1='kch=findobj(''Tag'',''HAZARD_KPREDEF'');preval=get(kch,''Value'');';
...
predef3='mf=findobj(''Tag'',''HAZARD_MAIN'');udata=get(mf,''UserData'');udata.K=K;set(mf,''UserData'',udata);delete(gcf);HAZARD_kerdraw;';
uicontrol( ...
        'Style','push', ...
        'Units','normalized', ...
        'FontUnits','normalized',...
...
uicontrol( ...
        ...
        'String',mus);
%  button OK
optker1='KOPT_k=findobj(''Tag'',''HAZARD_KOPT_k'');k=eval(get(KOPT_k,''String''));';
optker2='KOPT_nu=findobj(''Tag'',''HAZARD_KOPT_nu'');nu=eval(get(KOPT_nu,''String''));';
optker3='KOPT_mu=findobj(''Tag'',''HAZARD_KOPT_mu'');mu=eval(get(KOPT_mu,''String''));';
optker4='K=K_def(''opt'',nu,k,mu);mf=findobj(''Tag'',''HAZARD_MAIN'');udata=get(mf,''UserData'');udata.K=K;set(mf,''UserData'',udata);delete(gcf);HAZARD_kerdraw;';
uicontrol( ...
        'Style','push', ...
        'Units','normalized', ...
        'FontUnits','normalized',...
