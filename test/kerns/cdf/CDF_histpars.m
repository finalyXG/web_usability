...
SaveHistBins1='hb=findobj(''Tag'',''CDF_HPAR'');hist_bits=eval(get(hb,''String''));';
SaveHistBins2='mf=findobj(''Tag'',''CDF_MAIN'');udata=get(mf,''UserData'');';
SaveHistBins3='udata.hist_bits=hist_bits;set(mf,''UserData'',udata);delete(gcf);CDF_histdraw';
%  button OK
uicontrol( ...
        'Style','push', ...
        'Units','normalized', ...
