function KDE_randtool(action,flag)
%KDE_RANDTOOL Demonstration of many random number generators.
%   KDE_RANDTOOL creates a histogram of random samples from many
...
if strcmp(action,'start'),
   ...
   for idx = 1:3
       ...
       ud.pfhndl(idx) = uicontrol('Style','edit','Units','normalized','Position',pos{1,idx},...
          ...
          'CallBack',['KDE_randtool(''setpfield'',',nstr,')']);
       ...
       ud.hihndl(idx) = uicontrol('Style','edit','Units','normalized','Position',pos{2,idx},...
         ...
         'CallBack',['KDE_randtool(''setphi'',',nstr,')']);
       ...
       ud.lohndl(idx) = uicontrol('Style','edit','Units','normalized','Position',pos{3,idx},...
         ...
         'CallBack',['KDE_randtool(''setplo'',',nstr,')']);
       ...
       ud.pslider(idx) = uicontrol('Style','slider','Units','normalized','Position',pos{4,idx},...
         ...
         'Min',ud.dists(dfltDist).plo(2-rem(idx,2)),'Callback',['KDE_randtool(''setpslider'',',nstr,')']);
   ...
   ud.popup=uicontrol('Style','Popup','String',distNameList(1:end-1),...
        ...
        'CallBack','KDE_randtool(''changedistribution'')');

   ud.samples_field = uicontrol('Style','edit','Units','normalized',...
         'Position',[.71 .945 .15 .04], 'String','100',...
         'BackgroundColor','white',...
         'CallBack','KDE_randtool(''setsample'',1)');

   uicontrol('Style','Pushbutton',...
         'Units','normalized','Position',[.70 .02 .13 .04],...
         'Callback','KDE_randtool(''setsample'',1)','String','Resample');

   uicontrol('Style','Pushbutton','Units','normalized',...
         'Position',[.84 .02 .13 .04],...
         'Callback','KDE_randtool(''output'',2);','String','Save');

   uicontrol('Style','Pushbutton','Units','normalized',...
         'Position',[.1 .02 .13 .04],...
         'Callback','KDE_randtool(''cancel'',2);','String','Cancel');
...
% END OF KDE_randtool MAIN FUNCTION.
...
if ~isempty(errstr)
   error('stats:KDE_randtool:GeneratorError',...
